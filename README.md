...
> Answer: Client-Side Routing allows you to change a state on a website without having to refresh the entire page. Because less data is being processed client-side routing is generally faster than server-side routing.
